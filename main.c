...
char *usage =
    "Usage: %s -s spline-file [-p points-file] [ -g gnuplot-file [-f from_x -t "
    "to_x -n n_points ] ]\n"
    ...
    "               - from_x defaults to x-coordinate of the first point in "
    "points-file,\n"
...
int main(int argc, char **argv) {
  ...
  /* if points-file was given, then read points, generate spline, save it to
   * file */
  if (inp != NULL) {
